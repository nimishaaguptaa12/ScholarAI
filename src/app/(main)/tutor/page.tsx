...
export default function TutorPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm your AI Tutor. What subject would you like to study today? You can ask me to explain concepts, test your knowledge, or create flashcards for you.",
    },
  ]);
